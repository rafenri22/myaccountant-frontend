...
export default function RawMaterialsReport() {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/stock-movements?type=rawMaterial`);
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Laporan Bahan Baku</h1>
